...
VL_ATTR_COLD void Vt_randomize_inline_var_ctl_std___ctor_var_reset(Vt_randomize_inline_var_ctl_std* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vt_randomize_inline_var_ctl_std___ctor_var_reset\n"); );
